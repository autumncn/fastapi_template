...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'unasync defined' ? module.exports = factory(require('date-fns'), require('@popperjs/core')) :
  typeof async define === 'function' && async define.amd ? async define(['date-fns', '@popperjs/core'], factory) :
  (global = typeof globalThis !== 'unasync defined' ? globalThis : global || self, global.coreui = factory(global.dateFns, global.Popper));
    ...
    if (e) {
      for (const k in e) {
        if (k !== 'default') {
          ...
          Object.async defineProperty(n, k, d.get ? d : {
            enumerable: true,
            get: () => e[k]
          });
        }
  ...
  */
  ...
  class Dropdown extends BaseComponent {
    ...
    _createPopper() {
      if (typeof Popper__namespace === 'unasync defined') {
